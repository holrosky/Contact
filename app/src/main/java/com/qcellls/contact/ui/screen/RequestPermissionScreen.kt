...
@Composable
fun PermissionRequireContent(onClick: () -> Unit, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
...
@Composable
fun PermissionDeniedDialog(onDismiss: () -> Unit, modifier: Modifier = Modifier) {
    AlertDialog(
        modifier = modifier,
